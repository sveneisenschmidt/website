...
Good ideas are not enough to justify the work: what matters is whether something will change, for whom, at what cost, and whether it needs to happen at all. Some of the questions below are specific to roadsurfer, where removing manual work is one of the central objectives.
...
- **Start smaller and validate before committing**: most things that fail do so at a scale that was never necessary.
...
- **Build relationships before decisions need to be made**: share your point of view early to shape things before things are decided, and use those same conversations to understand what is frustrating your stakeholders before it becomes a crisis. If a stakeholder reaches out to me to find out what someone on my team is working on for them, that person has not built the relationship yet.
- **Define what needs to happen, leave the how to the team**: specifying the how is micromanagement, even when it is disguised as sharing an opinion.
- **Make wins as visible as problems**: if you don't, the team operates as if there is only ever a deficit.

## As a leader

The way I think about leadership is mostly structural: what conditions you create for others, not how present you are in the execution.

- **Empowerment is a structural test, not a style preference**: if the team still needs you after sign-off, the design is not done. Stepping in is sometimes necessary, but making it a habit prevents the team from growing.
...
- **Push back on learned helplessness**: identifying the pattern, naming it, and pushing for ownership is more useful than accepting that the team cannot move without support.
